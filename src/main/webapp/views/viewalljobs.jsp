...
<%@ page import="com.example.com.wu.jobproject.model.JobPost" %>
<%@ page import="com.example.com.wu.jobproject.repo.JobRepo" %>
<!DOCTYPE html>
<html lang="en">
    <head>
    <meta charset="UTF-8">
            ...
            <div class="container">
			    ...
			    <div class="collapse navbar-collapse" id="navbarNav">
				    <ul class="navbar-nav ms-auto">
					    ...
					    <li class="nav-item"><a class="nav-link" href="https://github.com/shwet0710">Contact</a></li>
				    </ul>
			    </div>
		    </div>
	    </nav>
